...
class MainActivity : AppCompatActivity(), ShopItemFragment.OnEditingFinishedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.shopList.observe(this) {
            shopListAdapter.submitList(it)//Когда мы вызываем метод submitList, то внутри адаптера запускается новый поток, в котором происходит все вычисления. Когда вычисления
            //окончены, то список обновляется
